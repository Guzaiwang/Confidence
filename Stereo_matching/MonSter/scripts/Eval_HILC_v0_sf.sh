...
# 设置基础路径
BASE_PATH="/DATA/i2r/guzw/workspace/Harmonious_confidence/Stereo_matching/MonSter/checkpoints/train_HILC_sceneflow_v0"
LOG_DIR="./outputs/EVAL_LOGS/HILC_sceneflow_v0"
...
for checkpoint in $(seq 32000 4000 40000); do
